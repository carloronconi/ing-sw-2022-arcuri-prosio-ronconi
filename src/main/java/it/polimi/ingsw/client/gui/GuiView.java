...
public class GuiView implements ViewInterface {
    ...
    private ClientNameIdConverter initialStateConverter;
    ...
    public ClientNameIdConverter getInitialStateConverter() {
    ...
    public void getAssistantCard() {
        ...
        Platform.runLater(new ChangeScene(name, clientGui, (s, c)->{
            if (c instanceof SetAssistantSceneController){
                ...
                ArrayList<Integer> assistantDeck = gameState.getAssistantDecks().get(new ClientNameIdConverter(gameState).nameToId(clientGui.getFinalNickname(), ClientNameIdConverter.ConverterSetting.PLAYER));
    ...
    public void gameOver(UUID winner) {
        ...
        if (winner!=null) this.winner = converter.idToName(winner, ClientNameIdConverter.ConverterSetting.PLAYER);
    ...
    public synchronized void update(ModelEvent modelEvent) {
        ...
        if (initialStateConverter==null) initialStateConverter = new ClientNameIdConverter(gameState);
